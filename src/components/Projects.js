...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      date: 'Shenyang Aerospace Teaching and Training Center, Liaoning China',
      images: [
        '/images/project3-1.jpeg',
        '/images/project3-2.jpeg',
        '/images/project3-3.jpeg',
        '/images/project3-4.jpeg',
        '/images/project3-5.jpeg',
        '/images/project3-6.jpeg',
      ],
      what: [
